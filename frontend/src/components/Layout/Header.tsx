        ...
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <div className="relative">
              ...
              <div className="relative flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-accent-500 to-fuchsia-500 shadow-lg shadow-accent-500/20">
                <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </div>
            </div>
            <div>
              <h1 className="text-base sm:text-lg font-bold tracking-tight gradient-text leading-tight">
                F&O Dashboard
              </h1>
              <p className="hidden sm:block text-[11px] text-surface-400 tracking-wide leading-tight">
          ...
          <div className="flex items-center gap-3 sm:gap-6 shrink-0">
            ...
            >
              <div
                className={cn(
                  'flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 rounded-full text-[10px] sm:text-xs font-medium transition-all duration-300',
                  isConnected
